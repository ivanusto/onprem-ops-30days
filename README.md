...
| [07](days/day-07.md) | 案例 ComfyUI：自建 image 的版本鎖定、GPU 直通與資料目錄的三層分離 | `packaging` | 撰寫中 | [qnap-comfyui-qpkg@v0.35.1-2](https://github.com/ivanusto/qnap-comfyui-qpkg/tree/v0.35.1-2)<br>[qnap-comfyui-qpkg@v0.35.1-3](https://github.com/ivanusto/qnap-comfyui-qpkg/tree/v0.35.1-3) |
| [08](days/day-08.md) | 案例 Open WebUI 加 Ollama（暫定） | `packaging` | 即將發表 |   |
