...
| [08](days/day-08.md) | 案例實戰：Open WebUI + Ollama 重構記，把專案回到通用框架會省下什麼呢？ | `packaging` | [閱讀](https://ithelp.ithome.com.tw/articles/10415241) | [open-webui-ollama-qpkg@v1.0.8](https://github.com/ivanusto/open-webui-ollama-qpkg/tree/v1.0.8)<br>[open-webui-ollama-qpkg@v2.0.0](https://github.com/ivanusto/open-webui-ollama-qpkg/tree/v2.0.0)<br>[qpkg-template@v0.2.1](https://github.com/ivanusto/qpkg-template/tree/v0.2.1) |
